...
|------------|-----------------|------------------------|---------------------------------------------------------|
<<<<<<< HEAD
|Team_Costco |AnkiDroid       |247K                    |AnkiDroid is an educational mobile application providing a flashcard system accompanied by simple UI. This project can be implemented using Android Studio, making it runnable and testable. The PR and issue submissions are recent and are actively being maintained. It has a detailed user manual that introduces the functions of all of its features, from basic to advanced, which will help us delve into and reverse engineer the project.                                                         |
